...
public class CyclesGoldenFibo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(containsDigit(1023467,1));
        System.out.println(isGoldenTriangle(161705,161705,100000));}
    }
...
//        а следующее является снованием. И если найдены Золотые треугольники, вывести на консоль длины
//        основания и рёбер этих треугольников.
